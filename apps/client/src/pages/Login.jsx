  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[var(--bg2)] px-4">
      <div className="w-full max-w-[400px] bg-white border-[1.5px] border-[var(--border)] rounded-[14px] p-8">
        ...
        {welcome && (
          <div className="bg-green-50 border border-green-200 text-green-700 text-[12px] font-medium rounded-[8px] px-3 py-2.5 mb-4">
            ✅ Account created! Log in to get started.
          </div>
        )}

        <h1 className="text-[15px] font-bold text-[var(--ink2)] mb-6">Log in to your account</h1>
        ...
        <div className="text-[12px] text-[var(--ink3)] mt-5 text-center">
          ...
          <Link to="/signup" className="text-[var(--acc)] font-semibold hover:underline">Sign up</Link>
        </div>
